                ...
                <div class="container-fluid">
                    ...
                    <div class="container mt-4 mb-4 p-3 d-flex justify-content-center"> 
                        ...
                        <div class=" image d-flex flex-column justify-content-center align-items-center"> 
                            ...
                            <img src="img/no-image.png" height="100" width="100" />
                            </button> 
                            <!--Nombre del perfil-->
                            <?php
                            ##incluimos la conexion con la bd desde la clase conexion
                            include 'Cone/conexion.php';
                             $consulta="SELECT id_usuario,usuario,password,Tipo,tbl_cliente.Nombre,tbl_cliente.Apellido,tbl_cliente.Email,tbl_cliente.Fecha,
