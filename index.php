      ...
      function drawChart() {
        ...
        data.addRows([
            <?php 
                ...
                $consulta="SELECT count(Tipo), Tipo FROM tbl_usuario WHERE Tipo='Empleado';";
                if($result = $conn->query($consulta)){
                    While($row = $result->fetch_assoc()){
                        $empleadotipo=$row['count(Tipo)'];
                        $tipoempleado=$row['Tipo'];
                
                ?>
          ['<?php echo $tipoempleado?>', <?php echo $empleadotipo?>],
          <?php 
                    }
                }
          ...
          ?>
                <?php 
                include 'Cone/conexion.php';
                $consulta="SELECT count(Tipo), Tipo FROM tbl_usuario WHERE Tipo='Cliente';";
                if($result = $conn->query($consulta)){
                    While($row = $result->fetch_assoc()){
                        $empleadotipo=$row['count(Tipo)'];
                        $tipoempleado=$row['Tipo'];
          ...
          <?php 
                include 'Cone/conexion.php';
                $consulta="SELECT count(Tipo), Tipo FROM tbl_usuario WHERE Tipo='Admin';";
                if($result = $conn->query($consulta)){
                    While($row = $result->fetch_assoc()){
                        $empleadotipo=$row['count(Tipo)'];
                        $tipoempleado=$row['Tipo'];
...
<script type="text/javascript">
      ...
      function drawStuff() {
        var data = new google.visualization.arrayToDataTable([
          ...
          <?php
          include 'Cone/conexion.php';
          $consulta="SELECT count(Tipo_id),Tipo_producto FROM tbl_productos
          INNER join tbl_tipoproducto
          ON tbl_productos.Tipo_id = tbl_tipoproducto.id_tipo
          WHERE Tipo_producto = 'Alimenticio';";
          if($result = $conn->query($consulta)){
              While($row = $result->fetch_assoc()){
                $conteo=$row['count(Tipo_id)'];
                $tipoprod=$row['Tipo_producto'];
          ?>
          ["<?php echo $tipoprod?>", <?php echo $conteo?>],
          <?php 
              }
            }
          ?>
        ...
        var options = {
          ...
          chart: { title: 'producto',
                   subtitle: 'Cantidad de producto por Tipo' },
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="SobreNosotros.php">
                    <i class=""></i>
                    <span>Sobre nosotros</span></span></a>
            </li>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                ...
                                                $consulta="SELECT sum(Total) FROM tbl_pago;";

                                                if($result = $conn->query($consulta)){
                                                    While($row = $result->fetch_assoc()){
                                                        $suma=$row['sum(Total)'];
                                                ?>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">LPS.<?php echo number_format($suma, 2, '.', ',')?></div>
                                            <?php
                                            }
                                        }
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                ...
                                                $newdateinicio=date("d/m/Y", strtotime($fecha_actual));
                                                
                                                ?>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $newdateinicio?></div>
                                        </div>
                                        <div class="col-auto">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <?php
                                                     include 'Cone/conexion.php';
                                                     #preparamos la consulta a realizar 
                                                     $consulta="SELECT AVG(Estado) FROM tbl_tareas;";

                                                     if($result = $conn->query($consulta)){
                                                        While($row = $result->fetch_assoc()){
                                                            $estado=$row['AVG(Estado)'];
                                                    
                                                    ?>
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo number_format($estado, 2, '.', ',')?>%</div>
                                                    <?php
                                                        }
                                                    }
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                ...
                                                include 'Cone/conexion.php';
                                                #preparamos la consulta a realizar 
                                                $consulta="SELECT count(Estado) FROM tbl_pago WHERE Estado='Tienda';";

                                                if($result = $conn->query($consulta)){
                                                   While($row = $result->fetch_assoc()){
                                                        $pedidos=$row['count(Estado)'];
                                                ?>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $pedidos?></div>
                                            <?php 
                                              }
                                            }
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- <div class="mt-4 text-center small">
                                        ...
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-success"></i> Empleado
                                        </span>
                                        <span class="mr-2">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    WHERE Fecha_fin <='$fecha_actual' limit 5;";
                                    ...
                                    ?>
                                    <h4 class="small font-weight-bold"><?php echo $tarea?> <span
                                            class="float-right"><?php echo $estado?>%</span></h4>     
                                    ...
                                    <?php if($estado==20){?>
                                        <div class="progress mb-4">
                                            ...
                                            <?php }elseif($estado==40){?>
                                        <div class="progress mb-4">
                                            <div class="progress-bar bg-warning" role="progressbar" style="width: 40%"
                                            aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                            <?php }elseif($estado==60){?>
                                        <div class="progress mb-4">
                                            <div class="progress-bar" role="progressbar" style="width: 60%"
                                            aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                            <?php }elseif($estado==80){?>
                                        <div class="progress mb-4">
                                                <div class="progress-bar bg-info" role="progressbar" style="width: 80%"
                                                aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                            <?php }elseif($estado==100){?>
                                            <div class="progress">
                                    ...
                                    <h4 class="small font-weight-bold">Reunión diara de equipo<span
                                            class="float-right">60%</span></h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar" role="progressbar" style="width: 60%"
                                            aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <h4 class="small font-weight-bold">Verificación de inventario<span
                                            class="float-right">80%</span></h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar bg-info" role="progressbar" style="width: 80%"
                                            aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <h4 class="small font-weight-bold">Confirmar solicitud de pedidos<span
