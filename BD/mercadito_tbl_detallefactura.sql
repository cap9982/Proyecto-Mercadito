...
CREATE TABLE `tbl_detallefactura` (
  ...
  PRIMARY KEY (`Factura_id`,`Productos_id`),
  KEY `fk_tbl_detallefactura_tbl_productos_idx` (`Productos_id`),
  CONSTRAINT `fk_tbl_detallefactura_tbl_productos` FOREIGN KEY (`Productos_id`) REFERENCES `tbl_productos` (`id_producto`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `tbl_detallefactura` VALUES (1,118),(2,143),(3,630),(4,744),(5,855),(10,920),(9,1021),(6,1707),(7,1820),(8,2158);
