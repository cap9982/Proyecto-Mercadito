...
CREATE TABLE `tbl_carrito` (
  ...
  PRIMARY KEY (`id_carrito`,`Cliente_id`,`Producto_id`),
  KEY `tk_tbl_carrito_tbl_productos_idx` (`Producto_id`),
  CONSTRAINT `tk_tbl_carrito_tbl_productos` FOREIGN KEY (`Producto_id`) REFERENCES `tbl_productos` (`id_producto`) ON DELETE CASCADE ON UPDATE CASCADE
