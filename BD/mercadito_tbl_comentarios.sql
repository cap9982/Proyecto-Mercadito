...
CREATE TABLE `tbl_comentarios` (
  ...
  PRIMARY KEY (`Id_comentario`,`Usuario_id`,`Producto_id`),
  KEY `fk_tbl_comentario_tbl_usuario_idx` (`Usuario_id`),
  KEY `fk_tbl_comentario_tbl_productos_idx` (`Producto_id`),
  CONSTRAINT `fk_tbl_comentario_tbl_usuario` FOREIGN KEY (`Usuario_id`) REFERENCES `tbl_usuario` (`id_usuario`) ON DELETE CASCADE ON UPDATE CASCADE
