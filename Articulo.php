        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Articulo</h1>
                    <div class="row">
                    
                    <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Pasta Colgate</h6>
                                </div>
                                
                                <div class="col-sm-6 mb-3 mb-sm-0" >
                                
                                <div class="card-body">
                                <img src="img/234270-1600-1600.png" alt="" width="350px" height="350px" >
                                <div class="prueba">
                                    <p>The styling for this basic card example is created by using default Bootstrap
                                        utility classes. By using utility classes, the style of the card component can be
                                        easily modified with no need for any custom CSS!</p>
                    ...
                    <ul class="comments-list">
                        <li>
                            <div class="coment-main-level">
                                <!--Avatar-->
                                <div class="coment-avatar"><img src="img/e397f694286ce843039af38a42969c74.jpg"></div>
                                <!--comentario-->
                                <div class="comment-box">
                                <div class="comment-head">
                                    <h6 class="comment-name by-author">Julian Alvarez</h6>
                                    <span>Fecha</span>
                                    <i class="fa fa-reply"></i>
                                </div>
                                <div class="comment-content">
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit dignissimos excepturi 
                                    tempore omnis iste, repellendus debitis assumenda modi distinctio quas.
                                </div>
                                </div>
                            </div>
                            <!--respuestas-->
                            <ul class="comments-list reply-list">
                                <li>
                                        <!--Avatar-->
                                        <div class="coment-avatar"><img src="img/026cf4fccb44d4094bace0100c89e689.jpg"></div>
                                        <!--comentario-->
                                        <div class="comment-box">
                                        <div class="comment-head">
                                            <h6 class="comment-name">Fernanda Mendoza</h6>
                                            <span>Fecha</span>
                                            <i class="fa fa-reply"></i>
                                        </div>
                                        <div class="comment-content">
