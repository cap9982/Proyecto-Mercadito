...
<head>
    ...
    <script src="https://www.paypal.com/sdk/js?client-id=AVIgW5KUzIT5wl8xsjTW4D6-XYePTGIY6WOvGOwXMTTOB3Ay0bp4HqyQlFzEI2ti4Mp_2davLFuZwNJd&currency=USD"></script>
    <?php
session_start();
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Pago de Compra</h1>
                    <!-- Carrito de compras -->
                    <div class="row">
                    <div class="col-6">
                ...
                <tbody name="tablacontenido">
                    ...
                    if($result = $conn->query($consulta)){
                        ...
                        While($row = $result->fetch_assoc()){
                            ...
                            $mosfoto=$row['Foto'];
                    ?>
                    <th scope="row"><?php echo $mosid?></th>
                    <td><?php echo $mospro?></td>
                    <td><?php echo number_format($mosprecio, 2, '.', ',')?></td>
