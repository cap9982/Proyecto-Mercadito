    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Promociones</h1>
                    <div class="row">
                    <?php 
                    ##incluimos la conexion con la bd desde la clase conexion
                    include 'Cone/conexion.php';
                    $consulta="SELECT tbl_ofertas.Descripcion,fecha_inicio,fecha_fin,Tipo_promo,Nombre_producto,Precio,Foto FROM tbl_ofertas 
                    INNER JOIN tbl_productos
                    ON tbl_ofertas.producto_id = tbl_productos.id_producto limit 4;";
                    ...
                    <div class="col-sm-3">
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"><?php echo $newdateinicio?></p>
                                <p class="card-text"><?php echo $newdatefin?></p>
                                <p class="card-text"><?php echo $tipopromo?></p>
        ...
        <div class="mostrador" id="mostrador">
            <div class="fila">
                ...
                $consulta="SELECT * FROM tbl_ofertas;";
                if($result = $conn->query($consulta)){
                ...
                While($row = $result->fetch_assoc()){
                    $mosdescripcion= $row['Descripcion'];
                    $mosinicio= $row['fecha_inicio'];
                    $mosfin= $row['fecha_fin'];
                    $mostipo= $row['Tipo_promo'];
                ?>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/1.png" alt="">
                    </div>
                    <p class="descripcion"><?php echo $mosdescripcion?></p>
                    <p class="descripcion"><?php echo $mosinicio?></p>
                    <p class="descripcion"><?php echo $mostipo?></p>
                    <span class="precio"><?php echo $mosfin?></span>
                </div>
                <?php
                }
            }
